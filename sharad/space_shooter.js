...
function Bullet(object) {
	...
	this.draw = function() {
		...
		else if (self === "bullet" && this.y >= 360) {
			return true;
		}
		else if (self === "enemyBullet" && this.y <= 0 ) {
			return true;
		}
		else {
			if (self === "bullet") {
...
function Ship() {
	 ...
	 */
	this.fire = function() {
		this.bulletPool.get(this.x+10, this.y, -3);
		game.laser.get();
	};
}
...
function Enemy() {
	 ...
	 */
	this.fire = function() {
		game.enemyBulletPool.get(this.x+this.width/2, this.y+this.height, +3);
	};
